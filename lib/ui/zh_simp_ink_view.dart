...
class ZhSimpInkView extends StatefulWidget {
  const ZhSimpInkView({super.key});

  @override
  State<ZhSimpInkView> createState() => _ZhSimpInkViewState();
}

class _ZhSimpInkViewState extends State<ZhSimpInkView> {
  ...
  final List<String> recognitionKanjiPlaceholder = ['请', '写', '一', '个', '汉', '字']; // "Write a kanji"
